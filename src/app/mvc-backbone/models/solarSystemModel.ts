...
export class SolarSystemModel {
    ...
    private onParametersChanged: Subject<BackendSatelliteData[]>;
    private onPlanetListChanged: Subject<BackendSatelliteData[]>;
    ...
    public addNewSatellite(newSatelliteName: string, primaryId: SatelliteIdentifier, params: SatelliteBackEndParameters, texture: string, initialPhase: number = 0): SatelliteIdentifier {
